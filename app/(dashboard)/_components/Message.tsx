...
const Message = () => {
  return (
    <div className="flex flex-col items-center justify-center border-b-1 px-8 py-4">
      <div className="flex items-center justify-center py-2 text-center">
        <div className="flex flex-col items-center justify-center px-2">
          ...
          <p className="py-8 font-thin">
            Whether you are planning a wedding, a corporate meeting or a social
            gathering, the diverse scope of Infinity Hospitality Group allows
            for the creation of unique events for all occasions.
          </p>
        ...
        <div className="flex flex-col items-center justify-center px-2">
          ...
          <p className="py-8 font-thin">
            Sign up for our Infinity Newsletter to receive wedding inspiration,
            helpful tips and tricks, see the hottest trends in Nashville
            weddings, and more delivered straight to your inbox!
          </p>
          <div className=" mb-8 h-full w-[50px] rounded-full bg-black py-4 pl-4 text-white hover:bg-blue-600 hover:text-white dark:bg-white dark:text-black dark:hover:bg-gray-600">
            <MdArrowForwardIos />
          </div>
      ...
      <p className="-mb-2 py-2 text-pink-400">
